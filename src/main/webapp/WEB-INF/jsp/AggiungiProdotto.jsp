		...
		<div class="container-fluid px-5">
  			...
  			<div class="row">
				<div class="col-12 col-sm-5 col-xl-4 ml-xl-5">
		  			<img src="${product.image}" class="img-thumbnail shadow w-75 mx-auto d-block" alt="Immagine Prodotto">
				</div>
				<div class="col-12 col-sm-6 col-xl-7">
		  			<form class="mr-xl-5">
					    ...
					    <div class="row my-2">
					      ...
					      <div class="col">
					        <input type="text" class="form-control" placeholder="Url Imagine" maxlength="256" value="${product.image}" id="image">
					      </div>
					    </div>
